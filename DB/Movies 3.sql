...
'Free Guy is a 2021 American science fiction action comedy film directed by Shawn Levy from a screenplay by Matt Lieberman and Zak Penn, and a story by Lieberman. It stars Ryan Reynolds as Guy, a bank teller who discovers he is actually a non-player character in an open-world video game and becomes the hero of the story, trying to save his friends from deletion by the game creator. Jodie Comer, Joe Keery, Lil Rel Howery, Utkarsh Ambudkar and Taika Waititi also star.',
